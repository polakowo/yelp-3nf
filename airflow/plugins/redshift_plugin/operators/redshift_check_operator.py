...
class RedshiftCheckOperator(CheckOperator):
    """
    Performs checks against Redshift. The ``RedshiftCheckOperator`` expects
    ...
    * Empty dictionary or set (``{}``)
    ...
    :type sql: str
    :param redshift_conn_id: reference to the Redshift database
...
class RedshiftValueCheckOperator(ValueCheckOperator):
    """
...
class RedshiftIntervalCheckOperator(IntervalCheckOperator):
    """
